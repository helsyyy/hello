		...
		<table>
			...
			<tr class='first_tr'>
         		<form action='setting.php' method='post'>
		         	<td><input required name="name" value=""></td>
		         	<td><input required name="info" value=""></td>
		         	<td><input required name="p_date" type="date" value=""></td>
		         	<td><textarea required name="info1"></textarea></td>
		         	<td><input required name="earnings" value=""></td>
		         	<td>
        	...
        	$person_arr = mysqli_query($connection,$str);
	         ...
	         while($person = mysqli_fetch_assoc($person_arr))
	         {
	         	...
	         	<tr>
	         		<form action='setting.php' method='post'>
			         	<td><input required name="name" value="<?php echo $person["name"] ?>"></td>
			         	<td><input required name="info" value="<?php echo $person["info"] ?>"></td>
			         	<td><input required name="p_date" type="date" value="<?php echo $person["p_date"] ?>"></td>

			         	<td>
			         		<textarea required name="info1"><?php echo $person["info1"] ?></textarea>
				        </td>

			         	<td><input required name="earnings" value="<?php echo $person["earnings"] ?>"></td>
